...
import { Loader2, Download, RefreshCcw, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-xl mx-auto">
                    Convert your JSON arrays into CSV format, perfect for Excel or Google Sheets.
                </p>
            </div>
                    ...
                    {!result ? (
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-muted-foreground mt-2">Your JSON has been converted to CSV.</p>
                            </div>
                ...
                <div className="space-y-6">
                    <div className="p-6 rounded-3xl bg-card border border-border sticky top-24">
                        ...
                        <p className="text-xs text-muted-foreground mb-6 leading-relaxed">
                            Input must be a JSON array of objects. Keys will be used as CSV headers.
                        </p>
