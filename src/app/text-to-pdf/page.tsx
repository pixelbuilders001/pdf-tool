...
export default function TextToPdfPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            for (const fileItem of files) {
                ...
                // Simple text placement. For long text, split by lines.
    ...
    const handleDownload = () => {
        if (result) {
            downloadBlob(result, 'converted_text.pdf', 'application/pdf');
        }
    };
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold mb-4">Text to PDF</h1>
                <p className="text-muted-foreground max-w-xl mx-auto">
                    Convert your plain text files into professional PDF documents.
                </p>
            </div>
                    ...
                    {!result ? (
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground mt-2">Your text has been converted to a PDF document.</p>
                            </div>
                ...
                <div className="space-y-6">
                    <div className="p-6 rounded-3xl bg-card border border-border sticky top-24">
                        ...
                        <p className="text-xs text-muted-foreground mb-6 leading-relaxed">
                            Plain text will be wrapped to fit standard A4 margins.
                        </p>
